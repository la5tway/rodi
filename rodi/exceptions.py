...
from .typings import AnyCallable, AnyType, Key
...
class FactoryMissingContextException(DIException):
    def __init__(self, function: AnyCallable) -> None:
        super().__init__(
...
class CannotResolveTypeException(DIException):
    ...
    def __init__(self, desired_type: Key):
...
class CannotResolveParameterException(DIException):
    ...
    def __init__(self, param_name: str, desired_type: AnyType):
        super().__init__(
...
class CircularDependencyException(DIException):
    ...
    def __init__(self, expected_type: AnyType, desired_type: AnyType):
        super().__init__(
...
class AliasAlreadyDefined(DIException):
    ...
    def __init__(self, name: str):
        super().__init__(
            ...
            "An alias with given name is already defined."
        )


class AliasConfigurationError(DIException):
    def __init__(self, name: str, _type: Optional[AnyType]):
        super().__init__(
...
class InvalidFactory(DIException):
    ...
    def __init__(self, _type: Optional[AnyType]):
        super().__init__(
...
class AbstractNotSupported(DIException):
    def __init__(self, _type: AnyType):
        super().__init__(
            f"The type '{class_name(_type)}' is abstract and cannot be instantiated."
        )
